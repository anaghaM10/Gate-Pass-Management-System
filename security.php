...
<body>
    ...
    <h1>Security Panel - Accepted Student List</h1>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            ...
            <?php 
            $leaves = mysqli_query($conn,"SELECT l.ename,u.department,u.year,l.descr,l.fromdate,l.exittime,l.eid,l.status FROM `users` u 
            inner join `leaves` l on u.id = l.eid where l.status = 'Accepted'");
