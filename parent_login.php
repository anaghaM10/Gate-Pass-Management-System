...
<?php
 	...
 	if (isset($_POST['login'])) {
	 	if (!empty($_POST['gemail'])) {
            ...
            $login = login_parent($gemail,$conn);          
	 	}
	 	else{
...
<form method="POST" class="parentloginForm">
<div class="alert alert-danger" id="invalidMsg">
    ...
    <input type="email" class="form-control" name = "gemail" id="gemail" placeholder="Guardian Email:">
    <button class = "btn btn-danger"id = "login-btn" type="submit" name="login">Generate OTP</button>
</form>
    </section>
