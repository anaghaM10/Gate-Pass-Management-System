...
<body>
    ...
    <h1>Admin Panel - Student Pass History</h1>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            ...
            <?php 
            $leaves = mysqli_query($conn,"SELECT l.ename,u.department,u.year,l.descr,l.fromdate,l.exittime,l.status FROM `users` u inner join `leaves` l on u.id = l.eid");
