...
<body>
    ...
    <h1>Electronics And Electrical Engineering  - 4th Year Students List</h1>
        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                          $leaves = mysqli_query($conn,"SELECT * FROM users WHERE type = 'Employee' AND department='EEE' AND year='4'");
                          if($leaves){
