...
<body>
    ...
    <h1>Electronics And Communication  - 3rd Year Students List</h1>
        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                          $leaves = mysqli_query($conn,"SELECT * FROM users WHERE type = 'Employee' AND department='ECE' AND year='3'");
                          if($leaves){
